Function Get-ZPAAppSegments{
    ...
    .EXAMPLE
        $appsegments = Get-ZPAAppSegments -token $token -customerid $customerid -zscalercloud config.zpagov.net
    ...
    $apiurl = "https://$($zscalercloud)/mgmtconfig/v1/admin/customers/$($customerid)/application"
