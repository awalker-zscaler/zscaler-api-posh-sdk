Function Get-ZPABackup {
    ...
    .EXAMPLE
        ...
        $backups = Get-ZPABackup -clientid "NwtY1ZmNYzM5ONMhZt0DCLTgNhFOMzzi0TMYJWgw0TZOTdmzUD0MDWIMEzOgNxZjQtT2UNzD" -clientsecret ']r[[9}b6mkdc*|FK}5NwQ)mU}]!+a04E' -zscalercloud "https://config.zpagov.net" -customerid "76543211234567890"
    ...
    begin{
        ...
        function Invoke-ZPAAPILOGIN {
            ...
            .EXAMPLE
                $response = Invoke-ZPAAPILOGIN -clientid "NwtY1ZmNYzM5ONMhZt0DCLTgNhFOMzzi0TMYJWgw0TZOTdmzUD0MDWIMEzOgNxZjQtT2UNzD" -clientsecret ']r[[9}b6mkdc*|FK}5NwQ)mU}]!+a04E' -zscalercloud "https://config.zpagov.net"
